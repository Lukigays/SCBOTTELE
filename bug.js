  ...
  bot.sendMessage(msg.chat.id, `Username: ${usernames}\nUser ID: ${user_id}`)
    {
      reply_markup: {
        inline_keyboard: [
          [
            { text: '🛒 LINK TELE OWNER TESTIOMI 🛒', url: 'https://t.me/@Darkfamly' }
          ]
        ]
      }
      parse_mode: "Markdown"
...
bot.onText(/\/script/, (msg) => {
    try {
        ...
        if (premiumUsers.has(msg.from.id.toString())) {
            ...
            bot.sendMessage(msg.chat.id, 'hai ' + (msg.from.username || 'Unknown') + '\nmaaf tidak bisa karena kamu belum menjadi user premium, mau jadi user premium?, bisa beli / sewa di saya admin @@Darkfamly', {
                reply_markup: {
                    inline_keyboard: [
                        [{
                            text: 'Beli Premium',
                            url: 'https://t.me/@Darkfamly'
                        }]
                    ]
                }
            });
...
bot.onText(/\/menubug/, (msg) => {
  ...
  bot.sendMessage(chatId, "USER MENU ⬇️\n" +
    ...
    "/allopen - list all open @Darkfamly\n" +
    ...
    "🔥 *INGIN MEMBELI SC / JADI MURID CRASH HUBUNGI SAYA DI BAWAH👇* 🔥",
    {
      reply_markup: {
        inline_keyboard: [
          [
            { text: '🔥CONTACT OWNER🔥', url: 'https://t.me/@Nanzzxbotz' }
          ]
        ]
      },
      parse_mode: "Markdown"
  ...
  bot.sendMessage(chatId, "🤖 BERIKUT MENU DDOS 🤖\n\n" +
    ...
    "🔥 BERIKUT MENU KAMI, MAU BUY SC BOT TEKAN BUTTON DIBAWAH 🔥",
    {
      reply_markup: {
        inline_keyboard: [
          [
            { text: '🛒 BELI SC BOT 🛒', url: 'https://t.me/@Darkfamly' }
          ]
        ]
      },
      parse_mode: "Markdown"
  ...
  bot.sendMessage(chatId, "USER MENU ⬇️\n" +
    ...
    "🔥 *INGIN MEMBELI SC / JADI MURID CRASH HUBUNGI SAYA DI BAWAH👇* 🔥",
    {
      reply_markup: {
        inline_keyboard: [
          [
            { text: '🔥CONTACT OWNER🔥', url: 'https://t.me/@Darkfamly' }
          ]
        ]
      },
      parse_mode: "Markdown"
  ...
  bot.sendMessage(chatId, "📌OPEN MURID BANNED \n\n\nKEUNTUNGAN :\n\n• DAPET METHOD BAND ALL NEGARA\n• DAPET METHOD ONE CLICK\n• DAPET METHOD BAN HARD\n• AUTO JADI KANG BANIDO\n• TEKS KEBAKAR? DIGANTI BARU\n• METHOD ALL PRIVATE SEMUA\n\nPRICE : PV OWNER KAMI⬇️",
    {
      reply_markup: {
        inline_keyboard: [
          [
            { text: '🛒 OWNER KAMI 🛒', url: 'https://t.me/@Darkfamly' }
          ]
        ]
      },
      parse_mode: "Markdown"
  ...
  bot.sendMessage(chatId, "Hi Kak, Jika Mau transfer owner saya uang bisa transfer ke nope di bawah\n0831xxxxxxxx\nMasih Ragu Sama owner aku? Cek aja channel testiomi owner aku yang ada di bawah ⬇️",
    {
      reply_markup: {
        inline_keyboard: [
          [
            { text: '🛒 LINK CHANNEL TESTIOMI 🛒', url: 'https://t.me/@Darkfamly' }
          ]
        ]
      },
      parse_mode: "Markdown"
  ...
  bot.sendMessage(chatId, "CHANNEL TESTIOMI SAYA ADA DI BAWAH👇",
    {
      reply_markup: {
        inline_keyboard: [
          [
            { text: '❗ CHENEL ❗', url: 'https://t.me/@Darkfamly' }
          ]
        ]
      },
      parse_mode: "Markdown"
...
bot.onText(/\/info/, (msg) => {
  const chatId = msg.chat.id;
        bot.sendMessage(chatId, 'Script : Bot Crash\nOwner : @Darkfamly\nVersion : 2.0\nIf you want to buy source. Contact @Darkfamly');
      });
...
bot.onText(/\/myprem/, (msg) => {
    try {
        ...
        if (premiumUsers.has(msg.from.id.toString())) {
            ...
            bot.sendMessage(msg.chat.id, 'Hallo ' + (msg.from.username || 'Unknown') + '\nJika Anda belum menjadi anggota premium, jangan khawatir! Anda juga dapat menikmati pengalaman yang luar biasa dengan mengupgrade ke keanggotaan premium kami. Silakan hubungi @Darkfamly untuk informasi lebih lanjut. 💼💰\nTerima kasih atas perhatian dan selamat bergabung dengan komunitas premium kami! 🎊🙌\n\n#PremiumMember #ExclusiveExperience #JoinTheCommunity', {
                reply_markup: {
                    inline_keyboard: [
                        [{
                            text: 'Beli Premium',
